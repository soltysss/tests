...
variable vpc_network_name {
  description = <<EOT
  VPC network of the Drone installation.
  This Drone deployment use existing VPC network that is different
  in the prod and dev environments.
  EOT
  type        = string
}
...
variable dns_zone_name {
  description = "DNS zone managed by a production account."
  type        = string
...
variable cloudsql_database_name {
  description = "CloudSQL MySQL database name."
  type        = string
  default     = "drone"
}

variable cloudsql_database_user {
  description = "CloudSQL MySQL database user."
  type        = string
  default     = "drone"
}
