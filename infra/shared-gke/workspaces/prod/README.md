...
|------|-------------|------|---------|:--------:|
| cluster\_name | n/a | `string` | `"shared-gke-prod"` | no |
| database\_instance\_name | n/a | `string` | `"shared-mysql-prod"` | no |
...
| min\_node\_count | Minimum number of Cluster nodes in the NodePool. Must be >= 1 | `number` | `1` | no |
| network\_name | The name of the VPC | `string` | `""` | no |
| node\_instance\_type | Instance type for cluster nodes | `string` | `"n1-standard-4"` | no |
